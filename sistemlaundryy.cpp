...
// Bubble sort berdasarkan status
void sortByStatus(Node *head) {
	...
	do {
		...
		while (current->next != NULL) {
			if (current->data.kodeStatus > current->next->data.kodeStatus) {
				nukerData(current, current->next);
				tukar = true;
			}
...
void sortByHarga(Node *head) {
	...
	do {
		...
		while (current->next != NULL) {
			if (current->data.totalHarga > current->next->data.totalHarga) {
				nukerData(current, current->next);
				tukar = true;
			}
...
void sortByBerat(Node *head) {
	...
	do {
		...
		while (current->next != NULL) {
			if (current->data.beratKg > current->next->data.beratKg) {
				nukerData(current, current->next);
				tukar = true;
			}
